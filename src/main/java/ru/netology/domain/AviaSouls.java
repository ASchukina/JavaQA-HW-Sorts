...
public class AviaSouls {
    ...
    public Ticket[] search(String from, String to) {
        ...
        Arrays.sort(result); // выводим результаты (соритруем) по умолчанию - от меньшего к боольшему
        return result;
    }
    ...
    public Ticket[] searchAndSortBy(String from, String to, Comparator<Ticket> comparator) {
        ...
        Arrays.sort(result, comparator); // выводим результаты с помощью компаратора
        return result;
    }
}
